...
<body>
	...
	<br><br>
	<h3 align="center">Here you can get all info about the musical instruments </h3>
	<h3 align="center">Just try with your fav musical instrument</h3><br><br>
	
	<div align="center"><br><br>
	 	 		<c:choose>
	 			<c:when test="${param.code eq '160'}">
	 				<div class="alert alert-danger">
	 					<p>Error. This Instrument Not Found....</p>
	 				</div>
	 			</c:when>
	 		</c:choose>
	 		</div><br><br>
